!(function(T) {
    ...
    var F = {
        ...
        attach: function(e) {
            var t,
                a = this;
            return (
                ((t = e ? F._saveOptions(a, e) : a.data("jqv")).validateAttribute =
                    a.find("[data-validation-engine*=validate]").length ?
                ...
                T(window).bind(
                    "resize", { noAnimation: !0, formElem: a },
        ...
        detach: function() {
            ...
            return (
                ...
                t.autoPositionUpdate &&
                T(window).off("resize", F.updatePromptsPosition),
                this
            );
        },
        validate: function(e) {
            ...
            if (a.is("form") || a.hasClass("validationEngineContainer")) {
                ...
                a.addClass("validating"),
                    (t = e ? F._saveOptions(a, e) : a.data("jqv"));
        ...
        _onSubmitEvent: function() {
            ...
            if (e.data("jqv_submitButton")) {
                ...
                if (
                    a &&
                    0 < a.length &&
                    (a.hasClass("validate-skip") ||
                        "true" == a.attr("data-validation-engine-skip"))
                )
                    return !0;
            }
            ...
            if (
                    ...
                    .each(function() {
                        ...
                        if (T.inArray(e.attr("name"), t) < 0) {
                            if (
                                ...
                                return !1;
                            if ((t.push(e.attr("name")), 1 == r.showOneMessage && i))
                                return !1;
                        }
                    }),
                ...
                if (r.scroll) {
                    ...
                    if ((r.scrollOffset && (e -= r.scrollOffset), r.isOverflown)) {
                        ...
                        T("html, body").animate({ scrollTop: e }, 1100, function() {
                            r.focusFirstField && o.focus();
                        }),
        ...
        _validateField: function(e, t, a) {
            if (
                (e.attr("id") ||
                    (e.attr(
                            "id",
                            "form-validation-field-" + T.validationEngine.fieldIdCounter
                        ),
            ...
            var o = i[1],
                ...
                c = !1;
            (t.isError = !1),
            (t.showArrow = 1 == t.showArrow),
            0 < t.maxErrorsPerField && (c = !0);
            for (
                var f = T(e.closest("form, .validationEngineContainer")), v = 0; v < s.length; v++
            )
            ...
            for (var p = 0; v < s.length; v++) {
                ...
                switch (s[v]) {
                    case "required":
                        (u = !0),
                        (g = F._getErrorMessage(f, e, s[v], s, v, t, F._required));
                        break;
                    case "custom":
                    ...
                    case "condRequired":
                        void 0 !==
                            (g = F._getErrorMessage(f, e, s[v], s, v, t, F._condRequired)) &&
                            (u = !0);
                        break;
                    case "funcCallRequired":
                        void 0 !==
                            (g = F._getErrorMessage(
                                f,
                                e,
                                s[v],
                                s,
            ...
            1 < f.find("input[name='" + n + "']").length &&
                ...
                t.prettySelect &&
                (e = f.find(
                    "#" + t.usePrefix + F._jqSelector(e.attr("id")) + t.useSuffix
                )),
                t.isError && t.showPrompts ?
                F._showPrompt(e, l, d, !1, t) :
                F._closePrompt(e),
        ...
        _getCustomErrorMessage: function(e, t, a, r) {
            ...
            if (
                ...
                void 0 !== r.custom_error_messages[s][a]
            )
        ...
        _required: function(e, t, a, r, i) {
            switch (e.prop("type")) {
                ...
                case "checkbox":
                    if (i) {
                        if (!e.prop("checked"))
                            return r.allrules[t[a]].alertTextCheckboxMultiple;
                        break;
                    }
            ...
            if (s)
                if (s.regex) {
                    ...
                    if ("function" != typeof(i = s.func))
                        return void alert(
                            "jqv:custom parameter 'function' is no function - " + o
                        );
        ...
        _showPrompt: function(e, t, a, r, i, o) {
            ...
            o && (s = !1),
                T.trim(t) &&
                (s ?
                    F._updatePrompt(e, s, t, a, r, i) :
                    F._buildPrompt(e, t, a, r, i));
        },
        _buildPrompt: function(e, t, a, r, i) {
            ...
            switch (
                (o.addClass(F._getClassName(e.attr("id")) + "formError"),
                    o.addClass(
                        "parentForm" +
                        F._getClassName(
                            e.closest("form, .validationEngineContainer").attr("id")
                        )
                    ),
            ...
            if (i.showArrow) {
                ...
                if ("string" == typeof s)
                    -
                    1 != (u = s.indexOf(":")) && (s = s.substring(0, u));
                switch (s) {
                    case "bottomLeft":
                    case "bottomRight":
            ...
            if (void 0 !== l) o.addClass(l);
                ...
                var d = T(
                    ...
                    e
                    .attr("id")
                    .substr(i.usePrefix.length)
                    .substring(i.useSuffix.length)
        ...
        _getPrompt: function(e) {
            var t = T(e).closest("form, .validationEngineContainer").attr("id"),
                ...
                r = T(
                    "." + F._escapeExpression(a) + ".parentForm" + F._getClassName(t)
                )[0];
            if (r) return T(r);
        },
        ...
        _saveOptions: function(e, t) {
            if (T.validationEngineLanguage)
                var a = T.validationEngineLanguage.allRules;
            else
                T.error(
        ...
        _submitButtonClick: function(e) {
            var t = T(this);
            t.closest("form, .validationEngineContainer").data(
                "jqv_submitButton",
                t.attr("id")
            );
        },
    ...
    (T.fn.validationEngine = function(e) {
        ...
        return t[0] ?
            ...
            "object" != typeof e && e ?
            void T.error(
                "Method " + e + " does not exist in jQuery.validationEngine"
            ) :
    ...
    T(function() {
        T.validationEngine.defaults.promptPosition = F.isRTL() ?
            "bottomLeft" :
            "bottomLeft";
    });
})(jQuery);